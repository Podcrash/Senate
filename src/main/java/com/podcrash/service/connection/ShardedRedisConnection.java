...
public class ShardedRedisConnection implements Connection<ShardedJedis> {

    private final RedisCredentials[] redisCredentials;
    private ShardedJedisPool shardedJedisPool;

    public ShardedRedisConnection(RedisCredentials[] redisCredentials) {
    ...
    public void connect() {
        ...
        for (RedisCredentials credentials : this.redisCredentials) {
